...
layer_name = "conv3_block4_out"#"conv5_block3_out"#"conv1_conv"#"conv5_block1_out"#
...
# model.summary() # for list of layer names
...
keras.preprocessing.image.save_img(layer_name+"0.png", img)
...
keras.preprocessing.image.save_img(layer_name+"_stiched_filters.png", stitched_filters)

from IPython.display import Image, display

display(Image(layer_name+"_stiched_filters.png"))
